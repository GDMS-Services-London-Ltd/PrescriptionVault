...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" ><i class="icon ion-ios-checkmark balanced"></i></button>',
      cancelTpl:    '<button type="button" ng-click="$form.$cancel()" ><i class="icon ion-ios-close assertive"></i></button>'
    },
